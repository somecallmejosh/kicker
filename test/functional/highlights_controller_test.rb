...
class HighlightsControllerTest < ActionController::TestCase
  ...
  test "should create highlight" do
    assert_difference('Highlight.count') do
      post :create, highlight: { comments: @highlight.comments, date: @highlight.date, link: @highlight.link, opponent: @highlight.opponent, title: @highlight.title }
    end
  ...
  test "should update highlight" do
    put :update, id: @highlight, highlight: { comments: @highlight.comments, date: @highlight.date, link: @highlight.link, opponent: @highlight.opponent, title: @highlight.title }
    assert_redirected_to highlight_path(assigns(:highlight))
  end
